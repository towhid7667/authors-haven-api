...
def test_update_details(normal_user):
    ...
    # Inspect the URL resolver
    resolved_view = resolve(url)
    print(f"Resolved view: {resolved_view.func}")
    print(f"Resolved view name: {resolved_view.view_name}")
    print(f"Resolved URL pattern: {resolved_view.url_name}")
